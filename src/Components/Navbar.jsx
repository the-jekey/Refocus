  ...
  return (
    <div className='max-w-screen-xl mx-auto p-3 flex justify-between text-white border-b-2  border-zinc-600' >
      <div className="left flex items-center">  
        ...
        <div className="links flex gap-14 items-center justify-center  ml-20">
          {[
            "Home", "Work", "Culture", "", "News",
          ].map((elem, index) => (
            elem.length === 0 ? <span className='w-[2px] h-4 bg-zinc-700'></span> : (<a className=' font-regular text-sm flex items-center gap-1' href="#">
              {index === 1 && (<span style={{ boxShadow: "0 0 0.45em #00FF19" }} className='inline-block size-2 bg-green-500 rounded-full'></span>)}
              {elem}
            </a>)
